...
/// </summary>
public sealed class PolyLinePropDraft : IPropDraft, IHasSegmentsDraft, IHasLightSettingsDraft
{
    ...
    /// <summary>Gets or sets the light string type used for the draft.</summary>
